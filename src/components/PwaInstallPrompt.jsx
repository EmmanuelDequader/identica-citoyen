      ...
      <div className="bg-slate-900/95 backdrop-blur-md text-white border border-slate-700/80 rounded-2xl p-4 shadow-2xl flex flex-col gap-3">
        <div className="flex items-start justify-between gap-3">
          <div className="flex items-center gap-3">
            <div className="w-10 h-10 rounded-xl bg-[#0c2551] border border-[#0aab72]/40 flex items-center justify-center shrink-0">
              <Smartphone className="w-5 h-5 text-[#0aab72]" />
            </div>
            <div>
